...
if(isset($_SESSION["user_name"]))
{
	...
	{	
		...
		$sql="INSERT INTO stock_details (entry_date, client, item, qty, lorry, driver, loading_time, invoice_number, invoice_date , godown_slip_number,godown)
			 VALUES
			 ('$entryDate', '$client', '$item', '$qty', '$lorry', '$driver',".var_export($time, true).", ".var_export($invoice_number, true).", ".var_export($invoice_date, true)." ,".var_export($godown_slip_number, true).",'$godown')";
