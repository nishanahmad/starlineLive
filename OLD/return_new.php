...
?>
<form name="frm" method="post" action="process_return_new.php">
<div style="width:100%;">
...
<td colspan="2"><div align ="center"><b><font style="size:4;color:red">Return Bag</font><b></td>
</tr>
...
<td><input type="text" class="txtField" name="godown_slip_number" required/></td>
</tr>

<td><label>Godown</label></td>
<td><select name="godown" class="txtField" required>
    <option value = "">---Select---</option>
<?php
