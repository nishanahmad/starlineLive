		...
		<div class="container" style="width:100% !important;font-size:1.60em !important">
			<section>
				<div class="tabs tabs-style-linemove">
					<nav>
						<ul>
							<li><a href="#" class="icon icon-date"><span>Price List</span></a></li>
				...
				<div class="contact-form">
					<form id="contact-us" method="post" action="update.php">
						...
						<table style="width:30%" class="" id="customerTable" >								
							...
							<tr><td><input type="text" name="customerName" id="customerName" class="form" value="<?php echo $order['customerName']; ?>" /></td></tr>
							<tr><td><input type="text" name="customerPhone" id="customerPhone" class="form" value="<?php echo $order['customerPhone']; ?>" /></td></tr>
						</table>
...
<?php								$total = $total + $item['qty'] * $item['price'];
						...
						<td style="width:15%;text-align:left;"><input type="text" name="discount" id="discount" value="<?php echo $order['discount'];?>" onChange="discountRefresh();" /></td>
						</tr>												
						<tr>
						...
						<table style="width:30%" style="border:1px;" name="plumberTable" id="plumberTable" class="plumberTable">	
							<tr><td><input type="text" name="masonName" id="masonName"  placeholder="Plumber Name..." value="<?php echo $order['masonName']; ?>"/></td></tr>
							<tr><td><input type="text" name="masonPhone" id="masonPhone" placeholder="Plumber Phone..." value="<?php echo $order['masonPhone']; ?>"/></td></tr>
						</table>			
						<br><br>
						<table>
						<tr>
						<td><button type="submit" class="btn">Update</button></td>
						<td style="vertical-align:bottom"><a href="view.php?id=<?php echo $order["id"]; ?>">Cancel</a></td>						
						</tr>
						</table>
