	...
	<body>			
		...
		<div align="center" id="fullPage" style="background-color:white;color:#000000">
			...
			<div style="float:left;margin-left:23%;text-align:left;width:50%;">
				ORDER <?php echo $id;?><br>
				REF <?php echo $order['quotation_id'];?><br>
				Name & Phone of Consignee:<br>  	
				<b><?php echo $order['customerName'].', '.$order['customerPhone']; ?></b>
			</div>
			<div style="float:right;margin-right:23%;text-align:left;">
			Date :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date("d-m-Y", strtotime($order['date']));?>			
			</div>				
			</font>	
...
<?php								$total = $total + $item['qty'] * $item['price'];
						...
						<tr>
							...
							<td style="width:13%;text-align:right;padding:5px"><?php echo $order['discount'];?></td>						
						</tr>												
						<tr>
							...
							<td style="padding:5px;width:13%;text-align:right;"><?php echo round($total * $order['discount']/100,2);?></td>
						</tr>												
						<tr style="border-bottom:1px solid black;">
							...
							<td style="padding:5px;width:13%;text-align:right;"><b><?php echo round($total - ($total * $order['discount']/100),2);?></b></td>						
						</tr>																		
						<tr>
						...
						<br><br>
						<?php echo substr($order['masonPhone'], -4);?>											
						<br><br>
					</div>						
				<br><br><br>						
			</div>
