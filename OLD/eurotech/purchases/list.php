				...
				<div class="tabs tabs-style-linemove">
					<nav>
						<ul>
							...
							<li class="tab-current"><a href="#" class="icon icon-tools"><span>Purchases</span></a></li>
					...
					<div align="center">
						<form action="new.php"><input type="submit" value="New Purchase"></form>
						<form action="../purchase_returns/list.php"><input type="submit" value="Return List"></form>											
						<br><br>
						...
						<input type="text" data-column="2"  class="search-input-text textarea" placeholder="Status">&nbsp&nbsp
					<br><br>
