...
if(isset($_SESSION["user_name"]))
{
	...
	$queryItems = mysqli_query($con,"SELECT * FROM return_items WHERE return_id = '$id'");
	$items = array();
			...
			<div class="inner contact">
				<div class="contact-form">
					<form id="contact-us" method="post" action="update.php">
						...
						<h3>rtn-<?php echo $id;?></h3>
						<br>
						<table style="width:30%" class="" id="customerTable" >								
							<tr><td><input type="text" name="date" id="date" class="form" required value="<?php echo date('d-m-Y',strtotime($return['date'])); ?>" /></td>
							<tr><td><input type="text" name="customerName" id="customerName" class="form" value="<?php echo $return['customerName']; ?>" /></td></tr>
							<tr><td><input type="text" name="customerPhone" id="customerPhone" class="form" value="<?php echo $return['customerPhone']; ?>" /></td></tr>
						</table>
...
<?php								$total = $total + $item['qty'] * $item['price'];
						...
						<td style="width:15%;text-align:left;"><input type="text" name="discount" id="discount" value="<?php echo $return['discount'];?>" onChange="discountRefresh();" /></td>
						</tr>												
						<tr>
						...
						<td style="vertical-align:bottom"><a href="view.php?id=<?php echo $return["id"]; ?>">Cancel</a></td>						
						</tr>
						</table>
						<br><br><br><br>
					</div>						
