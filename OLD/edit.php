...
?>
<form name="frm" method="post" action="process_edit.php?id=<?php echo $_GET['id'];?>" onsubmit="return godown_check()">
<div style="width:100%;">
...
<td><input type="time" <?php if($row['loading_time'] != '00:00:00') echo 'readonly';?> name="loading_time" value="<?php if($row['loading_time'] != '00:00:00') echo $row['loading_time'];?>"></td>
</tr>
